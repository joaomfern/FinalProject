<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Receita.aspx.cs" Inherits="ReceitasWeb.Receita.Receita" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="form-horizontal">
        <div class="form-group">
        <div class="text-center view overlay hm-white-slight" style="padding-top:30px">
            <hr />
        <h2 class="card-title">Crie a sua Receita!</h2>
             <hr />
          </div>  
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <div class="col-md-offset-2 col-md-10">
                <asp:Button id="button1" CausesValidation="False" runat="server" OnClick="Unnamed_Click" OnClientClick="return confirm('Quer prosseguir com a receita?','oi');" Text="Continuar para Ingredientes" CssClass="btn btn-warning" />
            </div>
        </div>
       </div>
</asp:Content>
